...
[[http://github.com/mads-hartmann/ocaml-utop-emacs-example][example project]] to provide concrete examples.

*Note*: This is the 2nd iteration. The setup was vastly simplified on
November 8 2014. The previous version can be found [[https://github.com/mads-hartmann/mads-hartmann.github.com/blob/8c9e7b4c7e262d298e7e2401446ae0fa34c148cb/_posts/2014-01-05-using-utop-in-emacs.markdown][here]].
...
everything loaded and ready when utop has launched. See [[https://github.com/mads-hartmann/ocaml-utop-emacs-example/blob/master/.ocamlinit][this
...
utop using ~-I <dir>~. Again See [[https://github.com/mads-hartmann/ocaml-utop-emacs-example/blob/master/.ocamlinit][this ~.ocamlinit~]] for a concrete
example.
...
projects[fn:1]. You can see a concrete example [[https://github.com/mads-hartmann/ocaml-utop-emacs-example/blob/master/.dir-locals.el][here]]. An example is
shown below.
