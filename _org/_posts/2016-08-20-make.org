...
this little example on [[https://github.com/mads379/mads379.github.com/tree/master/examples/markdown-site][Github]]. The project has the following structure.
...
enumerated in a file named ~requirements.txt~. First we remove the the
